...
import useOutsideClick from "@/useIt/useOutSideClick"
        ...
        <div className={prefix}>
            ...
            >
                <input
                    ...
                    name={name}
                    className={`w-full p-[14px] bg-gray-50 border border-[2px] ${errors.date ? "border-[#F54180]" : "border-[#E4E4E7]"
                        } text-gray-900 text-sm rounded-xl focus:ring-blue-500 focus:border-blue-500 block p-2.5`}
                />
                <svg
            ...
            {errors.date && (
                <p className="text-danger text-[12px] mt-[3px]">Please select a date</p>
            )}

            {opened && (
                <div
                    className={prefix + "__calendar-container shadow-medium"}
                    ref={datepickerRef}
                >
                    {selectionTab === "day" && (
                        <div>
