...
function ContactUs() {
  ...
  return (
    <div
      className="w-full items-center grid text-center justify-center h-[500px] md:h-[400px] sm:h-[300px] mt-[50px] md:mt-[40px] sm:mt-[30px] animate__animated animate__fadeInUp"
      style={{
        background: `linear-gradient(rgba(26, 26, 26, 0.75), rgba(26, 26, 26, 0.75)), url(https://picsum.photos/${
          1440 + 1
    ...
    >
      <div className="w-[80%] sm:w-[90%] mx-auto gap-[30px] smd:gap-[20px]">
        <h2 className="text-[white] text-[52px] md:text-4xl sm:text-2xl font-roboto font-bold text-center animate__animated animate__zoomInDown animate__slow">
